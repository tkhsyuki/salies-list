        ...
        <main className="max-w-4xl mx-auto px-4 py-20 bg-white">
            ...
            <div className="space-y-8 text-gray-700 leading-relaxed">
                <section>
                    ...
                    <p>この利用規約（以下「本規約」）は、アカリスト（以下「当サービス」）が提供する企業リスト販売サービス（以下「本サービス」）のご利用条件を定めるものです。</p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        1. 当サービスで提供するデータは、Web上の公開情報をプログラムにより自動収集（スクレイピング）・解析したものです。<br />
                        2. 情報の更新タイミングや収集元の状況により、実際の情報と異なる場合や、古い情報が含まれる場合があります。<br />
                        3. 当サービスは、提供するデータの正確性、完全性、最新性について一切の保証を行いません。データの内容に基づいて利用者が被った損害について、当サービスは一切の責任を負わないものとします。
                    </p>
                </section>
